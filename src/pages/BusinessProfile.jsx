      ...
      {!isFetching ? (
       <div className="business-profile-wrapper">
        <div className="upper-card">
         <Link
          to={`/business-profile/updatebusinessprofile/${id}`}
          className="edit"
         >
          Edit Profile
         </Link>
         <div className="business-logo">
          {businessProfile.logo ? (
           <Image
            ...
            loading="lazy"
            onClick={() =>
             handleImageClick(businessProfile.logo)
            }
           ></Image>
          ) : (
           <img
        ...
        <div className="lower-card1">
         ...
         <div className="profile-details">
          <div className="span">
           ...
           <h5 className="owners-name">
            {businessProfile.first_name +
             " " +
             businessProfile.last_name}
           </h5>
           <p className="business-profile-categories">
        ...
        <div className="lower-card2">
         ...
         <ReactMarkdown
          ...
          children={businessProfile.business_description}
         />
        </div>

        <div className="lower-card4">
         <h5 className="business-images-header">
          Business Images
         </h5>
         <div className="business-profile-images">
          {businessProfile.image.length > 0 ? (
           businessProfile.image.map((image, i) => (

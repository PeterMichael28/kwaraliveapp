                ...
                <div className='business-profile-wrapper'>
                            ...
                            <div className='business-logo'>
                                {   userProfile.image ? 
                                    <Image
                                        ...
                                        loading='lazy'
                                       onClick={() => handleImageClick(userProfile.image)}
                                        
                                        >
                                        
                                    </Image> : 
                                    <img src={img1} onClick={() => handleImageClick(img1)} className='business-logo' alt=''/>
                                }
                            </div>
                    ...
                    <div className='lower-card1'>
                        ...
                        <div className='profile-details'>
                            <div className='span'>
                                <h3 className='owners-name'>{userProfile?.first_name + ' ' + userProfile?.last_name}</h3>
                               
                            </div>
                            <div className='address-email-wrapper'>
                                <div className='address-wrapper'><img className='location' src={img4} alt=''/><p>{userProfile?.phone_number}</p></div>
                                <div className='email-wrapper'><img className='email' src={img3} alt=''/><p>{userProfile?.email}</p></div>
                            </div>
                    ...
                    <div className='lower-card2'>
                        <h5 className='business-description-header'>Address</h5>
                            <ReactMarkdown className='business-profile-description' children={userProfile?.address}/>
